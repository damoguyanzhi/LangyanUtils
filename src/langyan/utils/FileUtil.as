package langyan.utils
{
	...
	public class FileUtil
	{
		 ...
		 * 获取该文件夹中所有子目录
		 * @param file 文件
		 * @return array 子目录文件名数组
		 * */
		public static function getAllChildFolders(file:File):Array
		{
			var foldPathArr:Array=new Array;
			var childArr:Array=file.getDirectoryListing();
			for each(var i:File in childArr)
			{
				foldPathArr.push(i.name);
			}
			return foldPathArr;
		}
	}
